        ...
        <View className="h-full flex justify-between items-center px-6 py-10">
          <View className="w-full">
            ...
            <View className="w-full z-50 py-10">
              ...
              <View className="w-full">
                <Bigbox3 title="Message" haba={true} value={message} chest={countDes} setInputValue={setMessage} kind="default" type={checkDescrip}  placeholder="Describe your concern and our team will provide an assistance once we received your report"/>
              </View>
            </View>
          </View>
          ...
          <View className="w-full flex gap-y-4 p-2">
           {
            agent && (
              <Button onPress={()=>agentButton()} bgColor="bg-slate-200" textColor="text-neutral-700">
              Talk to agent
            </Button>
            )
           }
