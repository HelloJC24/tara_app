    ...
    <View className="w-full h-full bg-white absolute inset-0 z-50">
      ...
      <View className="h-full  relative">
        <View className="w-full flex flex-row items-center justify-between  px-6 pt-12 pb-4">
          <Pressable onPress={redirect == 'chat' ? ()=>navigation.goBack() : close}>
            <Svg
              xmlns="http://www.w3.org/2000/svg"
              width={30}
              height={30}
          ...
          >
            <View className="w-full">
              <View className="w-full flex items-center gap-y-2">
                ...
                >
                  This chat remains active for 24 hours with the driver, allowing you to reach out if you left any items. After that, the session will close.
                </ParagraphText>
              </View>
  ...
  return (
    <View className="w-full min-h-24 p-4 bg-red-500">
      ...
      <Text className="text-white text-center text-sm">
        To learn more check out our <Text onPress={()=>Linking.openURL("https://taranapo.com/faqs/")} className="text-blue-500 font-normal underline">Help Centre</Text> or chat us.
      </Text>
    </View>
  );
};
  ...
  return (
    ...
    >
      <View className="w-full h-full p-6 flex gap-y-4 ">
        ...
        Tara AI monitors your chat to protect against rude messages and automatically reports the rider/driver, saving you time.
        </ParagraphText>
        ...
        <View className="w-full flex gap-y-4">
          ...
          <Button onPress={()=>Linking.openURL("https://taranapo.com/auto-report/")} bgColor="bg-slate-200" textColor="text-blue-500">
            Learn More
          </Button>
        </View>
      </View>
  ...
  <View className="flex-row items-center  justify-center absolute top-0 bottom-0 mx-auto left-0 right-0 w-full py-4 px-12">
   
    {
      holdAudio ? (
        ...
        <Text className="text-center font-medium text-2xl">Calling ..</Text>
      )
    }
  </View>
...
<View>
<TouchableOpacity onPress={()=>CallHold()} className="bg-slate-200 h-20 w-20 rounded-full flex-row justify-center items-center">
